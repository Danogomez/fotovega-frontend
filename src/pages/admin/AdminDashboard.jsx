    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <div className="max-w-4xl mx-auto px-8 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Link to="/admin/contactos" className="group border border-white/10 hover:border-red-500/50 rounded-xl p-8 transition">
          <div className="text-4xl mb-4">✉️</div>
          <h3 className="text-xl font-light mb-2">Mensajes</h3>
          <p className="text-gray-500 text-sm">Ver mensajes de contacto</p>
          </Link>
